...
const SITE_URL = "https://arkinvests.pro";
...
export default function ReferralsClient() {
    ...
    const shareLinks = data
        ? {
              whatsapp: `https://wa.me/?text=${encodeURIComponent(`Join ARK Invest and start investing! Sign up with my referral link: ${referralLink}`)}`,
              telegram: `https://t.me/share/url?url=${encodeURIComponent(referralLink)}&text=${encodeURIComponent("Join ARK Invest and start investing!")}`,
              twitter: `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Join ARK Invest and start investing! ${referralLink}`)}`,
          }
        : {};
                ...
                <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6 sm:p-8 mb-6">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <button
                            ...
                            className="px-4 py-3 bg-blue-600 hover:bg-blue-500 rounded-lg text-xs font-bold tracking-widest uppercase text-white transition-all cursor-pointer shrink-0"
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {[
                            ...
                            <div key={item.step} className="flex gap-3">
                                <div className="w-8 h-8 rounded-full bg-blue-600/20 border border-blue-600/30 flex items-center justify-center text-blue-500 text-sm font-bold shrink-0">
                                    {item.step}
                                </div>
                                <div>
