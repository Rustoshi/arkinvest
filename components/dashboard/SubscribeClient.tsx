    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
            ...
            <div className="bg-[#050505] border border-white/[0.05] rounded-2xl p-6 relative overflow-hidden flex justify-between items-center group">
                <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/5 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/3 group-hover:bg-blue-500/10 transition-all duration-700" />
                        ...
                        plans.map((plan) => (
                            <button
                                ...
                                className={`w-full text-left relative overflow-hidden rounded-2xl border transition-all duration-300 p-6 ${selectedPlanId === plan._id
                                    ? 'bg-blue-500/5 border-blue-500/30 shadow-[0_0_30px_rgba(59,130,246,0.05)] scale-[1.02]'
                                ...
                                <div className="relative z-10 flex justify-between items-start">
                                    <div>
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            {plan.badge && (
                                                <span className="text-[9px] bg-blue-500/20 text-blue-400 px-2 py-0.5 rounded-full uppercase tracking-widest font-bold border border-blue-500/20">
                                                    {plan.badge}
                                                </span>
                                            )}
                                        </div>
                                    ...
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${selectedPlanId === plan._id ? 'bg-blue-500 text-white' : 'bg-white/[0.05] text-white/30'}`}>
                        ...
                        <div className="lg:hidden fixed inset-0 z-[9999] flex items-end animate-in fade-in duration-200">
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-[10px] uppercase tracking-widest text-blue-400 font-bold mb-0.5">Allocate Capital</p>
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between text-[10px] uppercase tracking-widest text-white/40">
                                        ...
                                        <span className="text-blue-400 font-mono normal-case">{currency}{userBalance.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                                    </div>
                                    <input
                                        type="number"
                                        value={amount}
                                        ...
                                        className="w-full bg-black border border-white/[0.1] rounded-xl px-4 py-4 text-lg font-mono text-white placeholder:text-white/20 focus:outline-none focus:border-blue-500/50 transition-colors"
                                    />
                                ...
                                <button
                                    ...
                                    type="submit"
                                    className="w-full flex justify-center items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white px-6 py-4 rounded-xl text-xs font-bold tracking-widest uppercase transition-colors shadow-lg shadow-blue-500/20"
                                >
                            ...
                            >
                                ...
                                <div className="p-5 space-y-2">
                                    <label className="text-[10px] uppercase tracking-widest text-white/50 flex justify-between">
                                        ...
                                        <span className="text-blue-400 font-mono">{currency}{userBalance.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                                    </label>
                                    <input
                                        type="number"
                                        value={amount}
                                        ...
                                        max={userBalance}
                                        placeholder="Enter amount"
                                        className="w-full bg-black border border-white/[0.1] rounded-xl px-4 py-4 text-lg font-mono text-white placeholder:text-white/20 focus:outline-none focus:border-blue-500/50 transition-colors shadow-inner"
                                    />
