        ...
        <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12 pb-32">
            ...
            >
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-blue-500 text-white text-[11px] font-bold tracking-widest uppercase py-4 px-8 rounded-xl hover:bg-blue-400 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                >
