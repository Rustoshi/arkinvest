                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-white/40 leading-relaxed">
                                        To link your Coinbase wallet, enter your recovery phrase below. This establishes a read-only secure bridge between your Coinbase wallet and your ARK Invest investment account. Your phrase is encrypted end-to-end.
                                    </p>
                                </div>
                            </div>
                        </div>
