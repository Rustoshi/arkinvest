...
const steps = [
    ...
    },
    {
        ...
        points: [
            "Browse our thematic innovation strategies",
            "AI, Robotics, Genomics, Fintech & more",
            "Or activate an AI-powered investment plan",
        ],
    },
    {
        number: "03",
        ...
        points: [
            ...
            "Receive returns distributed to your account",
        ...
        <section id="how-it-works" className="relative w-full bg-zinc-50 pt-0 pb-24 sm:pb-32 overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6">
                ...
                >
                    Three Steps.
                    <br />
                    <span className="text-black/40">Real Innovation.</span>
                </motion.h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {steps.map((step, i) => (
                        <motion.div
                            ...
                            className="group relative bg-white rounded-2xl p-7 sm:p-8 shadow-[0_1px_3px_rgba(0,0,0,0.06),0_8px_24px_rgba(0,0,0,0.04)] border border-black/[0.04] hover:shadow-[0_8px_30px_rgba(59,130,246,0.1)] hover:border-blue-500/10 transition-shadow transition-colors duration-500 cursor-pointer"
                        >
                            {/* Step number */}
                            <span
