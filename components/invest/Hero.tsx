...
const slides = [
    { src: "/images/hero1.jpg", alt: "Innovation", panDirection: "right" },
    { src: "/images/hero2.jpg", alt: "Technology", panDirection: "left" },
    { src: "/images/hero3.jpg", alt: "Growth", panDirection: "right" },
];
        ...
        <section className="relative w-full h-screen bg-black overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 pt-24 pb-16">
                ...
                <motion.div
                    ...
                    className="mb-6"
                >
                    <span className="text-[11px] sm:text-xs tracking-[0.3em] uppercase text-white/60 font-light border border-blue-500/30 rounded-full px-5 py-2 flex items-center gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />
                        Disruptive Innovation — Thematic Investing
                    </span>
                </motion.div>
                ...
                >
                    Innovation Is Key
                    <br />
                    <span className="text-blue-500">To Growth</span>
                </motion.h1>
                ...
                >
                    ARK identifies disruptive innovation across AI, robotics, energy storage, genomics, and blockchain — the technologies transforming industries and creating long-term growth opportunities.
                </motion.p>
                ...
                >
                    <button
                        ...
                        className="group px-8 py-3.5 bg-blue-600 text-white text-sm font-bold tracking-[0.1em] uppercase rounded-full transition-all duration-400 ease-out hover:bg-blue-500 hover:scale-[1.02] shadow-[0_0_30px_rgba(59,130,246,0.25)]"
                        style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                    >
                        View Strategies →
                    </button>
                    <Link
                        href="/invest/signup"
                        className="px-8 py-3.5 text-sm font-semibold tracking-[0.1em] uppercase text-white rounded-full border border-white/30 transition-all duration-400 ease-out hover:border-blue-500/50 hover:text-blue-400 hover:scale-[1.02]"
                        style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                    >
                        Create Account
                    </Link>
