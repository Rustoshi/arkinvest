...
const reviews: Review[] = [
    ...
    },
    {
        ...
        body: "The AI & Robotics strategy was exactly what my portfolio needed \u2014 real exposure to disruptive innovation. The platform feels like it was built for institutional investors, yet it's accessible to everyone.",
        invested: "$25,000",
        plan: "AI & Robotics",
    },
    {
    ...
    },
    {
        ...
        avatar: "MD",
        rating: 5,
        title: "The genomics strategy is brilliant",
...
function ReviewCard({ review, index }: { review: Review; index: number }) {
    return (
        <motion.div
            ...
            className="relative flex flex-col rounded-2xl p-7 sm:p-8 bg-white border border-black/[0.05] shadow-[0_1px_3px_rgba(0,0,0,0.06),0_8px_24px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(59,130,246,0.08)] hover:border-blue-500/10 transition-all duration-300 cursor-default min-w-0"
        >
            {/* Quote icon */}
            <Quote className="w-6 h-6 text-blue-500/15 mb-4 shrink-0" />
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6">
                ...
                <div className="text-center mb-16 sm:mb-20">
                    <motion.span
                        ...
                        className="inline-block text-[11px] tracking-[0.3em] uppercase text-blue-600 font-semibold mb-6"
                    >
