...
const blocks: RiskBlock[] = [
    ...
    },
    {
        ...
        description:
            "Capital is distributed across disruptive innovation themes including AI, genomics, and fintech to reduce concentration risk.",
    },
    {
...
function RiskCard({ block, index }: { block: RiskBlock; index: number }) {
    return (
        <motion.div
            ...
            className="relative rounded-2xl p-8 bg-white border border-black/[0.05] shadow-[0_1px_3px_rgba(0,0,0,0.06),0_8px_24px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(59,130,246,0.08)] hover:border-blue-500/10 transition-colors duration-300 cursor-default"
        >
            {/* Number accent */}
            <span
            ...
            {/* Accent bar */}
            <div className="w-8 h-[2px] bg-blue-500/30 rounded-full mb-4" />
