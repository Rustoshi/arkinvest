                ...
                {activeTab === 'edit' && (
                    <form onSubmit={handleUpdateUser} className="space-y-6 max-w-4xl animate-in fade-in duration-300">
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input name="firstName" type="text" defaultValue={user.firstName} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Last Name <span className="text-red-500">*</span></label>
                                            <input name="lastName" type="text" defaultValue={user.lastName} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                    </div>

                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Email Address <span className="text-red-500">*</span></label>
                                        <input name="email" type="email" defaultValue={user.email} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>

                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Phone Number <span className="text-red-500">*</span></label>
                                        <input name="phone" type="text" defaultValue={user.phone} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>

                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Country <span className="text-red-500">*</span></label>
                                        <select name="country" defaultValue={user.country} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors appearance-none">
                                    ...
                                    <div className="space-y-1.5 pt-4 border-t border-white/5">
                                        ...
                                        <input name="password" type="text" defaultValue={user.password} required className="w-full bg-red-500/5 border border-red-500/20 rounded-lg px-4 py-2.5 text-sm text-white font-mono tracking-wider focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>

                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Account Status <span className="text-red-500">*</span></label>
                                            <select name="accountStatus" defaultValue={user.accountStatus || 'active'} className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors appearance-none">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <select name="kycStatus" defaultValue={user.kycStatus || 'unverified'} className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors appearance-none">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input name="tierLevel" type="number" defaultValue={user.tierLevel || 1} min="1" max="3" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            ...
                                            <input name="withdrawalPin" type="number" defaultValue={user.withdrawalPin} placeholder="e.g. 1234" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white font-mono focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input name="withdrawalFee" type="number" defaultValue={user.withdrawalFee || 0} min="0" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                    </div>

                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Upgrade Fee ($)</label>
                                        <input name="upgradeFee" type="number" defaultValue={user.upgradeFee || 0} min="0" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>

                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Signal Fee ($)</label>
                                        <input name="signalFee" type="number" defaultValue={user.signalFee || 0} min="0" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                        ...
                        <div className="pt-6 border-t border-white/[0.05] flex gap-4 pr-2">
                            <button disabled={loadingTab === 'edit'} type="submit" className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white px-8 py-3 rounded-lg text-xs font-bold tracking-widest uppercase transition-colors">
                        ...
                        {transactionType === 'deposit' ? (
                            <form onSubmit={handleDeposit} className="space-y-5 bg-white/[0.02] border border-white/[0.08] p-6 rounded-xl animate-in fade-in zoom-in-95 duration-200">
                                ...
                                <div className="space-y-1.5 pt-2">
                                    ...
                                    <input name="amount" type="number" min="0.01" step="0.01" required placeholder="0.00" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-3 text-lg font-mono text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                </div>
                        ...
                        {planAction === 'subscribe' ? (
                            <form onSubmit={handlePlan} className="space-y-5 bg-white/[0.02] border border-white/[0.08] p-6 rounded-xl animate-in fade-in zoom-in-95 duration-200">
                                ...
                                <div className="space-y-1.5 pt-2">
                                    ...
                                    {systemPlans && systemPlans.length > 0 ? (
                                        <select name="planId" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors appearance-none">
                                            <option value="">-- Choose Plan --</option>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input name="investedAmount" type="number" min="0" required placeholder="0" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-3 text-sm font-mono text-white focus:outline-none focus:border-blue-500/50 transition-colors" disabled={!systemPlans || systemPlans.length === 0} />
                            ...
                            <form onSubmit={handlePlan} className="space-y-5 bg-red-500/5 border border-red-500/10 p-6 rounded-xl animate-in fade-in zoom-in-95 duration-200">
                                ...
                                <div className="space-y-1.5 pt-2">
                                    ...
                                    {userPlans && userPlans.length > 0 ? (
                                        <select name="planId" required className="w-full bg-black/50 border border-red-500/20 rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors appearance-none">
