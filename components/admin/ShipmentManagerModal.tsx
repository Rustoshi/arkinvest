...
export default function ShipmentManagerModal({ order, onClose }: Props) {
    ...
    const [carrier, setCarrier] = useState('ARK Logistics');
    ...
    const [originName, setOriginName] = useState('ARK Distribution Center');
    const [originAddress, setOriginAddress] = useState('3 East 28th Street, New York, NY 10016');
    ...
    const loadShipment = useCallback(async () => {
        ...
        if (res.success && res.shipment) {
            ...
            setShipment(s);
            setVin(s.vin || '');
            setCarrier(s.carrier || 'ARK Logistics');
                            ...
                            {!shipment && (
                                <div className="space-y-5">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <Field label="Carrier">
                                            <TextInput value={carrier} onChange={setCarrier} placeholder="ARK Logistics" />
                                        </Field>
                                    </div>
                                    ...
                                    <div className="pt-2 border-t border-white/[0.05]">
                                        ...
                                        <div className="space-y-3">
                                            <Field label="Facility Name">
                                                <TextInput value={originName} onChange={setOriginName} placeholder="ARK Distribution Center" />
                                            </Field>
                                            <Field label="Address">
                                                <TextInput value={originAddress} onChange={setOriginAddress} placeholder="3 East 28th Street, New York, NY 10016" />
                                            </Field>
                                        </div>
                                    </div>
