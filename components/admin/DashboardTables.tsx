            ...
            <div className="p-6 border-b border-white/[0.08] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="relative w-full sm:w-64">
                    ...
                    <input
                        ...
                        className="w-full bg-white/[0.05] border border-white/[0.1] rounded-lg pl-9 pr-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors"
                    />
                </div>
            </div>
            <div className="overflow-x-auto">
                    ...
                    <tbody>
                        {displayed.length === 0 ? (
                            ...
                            <tr key={user._id} className="border-b border-white/[0.04] hover:bg-white/[0.02] transition-colors">
                                ...
                                <td className="p-4 text-right">
                                    <Link href={`/admin/users/${user._id}`} className="inline-block text-xs font-bold uppercase tracking-wider text-blue-500 hover:text-white transition-colors bg-blue-500/10 hover:bg-blue-500 px-3 py-1.5 rounded cursor-pointer">Manage</Link>
                                </td>
                            </tr>
                        ))}
                    </tbody>
                    ...
                    <tbody>
                        {transactions.length === 0 ? (
                            ...
                            <tr key={tx._id} className="border-b border-white/[0.04] hover:bg-white/[0.02] transition-colors">
                                ...
                                <td className="p-4 text-right">
                                    <Link href="/admin/transactions/pending" className="text-xs font-bold uppercase tracking-wider text-blue-500 hover:text-white transition-colors bg-blue-500/10 hover:bg-blue-500 px-3 py-1.5 rounded">Review</Link>
                                </td>
                            </tr>
                        ))}
                    </tbody>
