                                    ...
                                    >
                                        ...
                                        <td className="p-4 text-right">
                                            <Link
                                                ...
                                                className="inline-block text-[10px] font-bold uppercase tracking-wider text-blue-500 hover:text-white transition-colors bg-blue-500/10 hover:bg-blue-500 px-3 py-1.5 rounded-lg cursor-pointer"
                                            >
                                                Manage
                                            </Link>
                                        </td>
