            ...
            <div className="p-6 md:p-8">
                    ...
                    <form onSubmit={handleSaveGeneral} className="space-y-6 max-w-2xl animate-in fade-in duration-300">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input name="companyEmail" type="email" defaultValue={companyDetails.companyEmail} required className="w-full bg-white/[0.03] border border-white/[0.1] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[10px] uppercase tracking-widest text-white/40">Contact Phone <span className="text-red-500">*</span></label>
                                <input name="contactPhone" type="text" defaultValue={companyDetails.contactPhone} required className="w-full bg-white/[0.03] border border-white/[0.1] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[10px] uppercase tracking-widest text-white/40">Company Address <span className="text-red-500">*</span></label>
                                <textarea name="companyAddress" defaultValue={companyDetails.companyAddress} required rows={3} className="w-full bg-white/[0.03] border border-white/[0.1] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors resize-none" />
                            </div>
                        </div>
                        <div className="pt-4 border-t border-white/[0.05]">
                            <button disabled={isSavingGeneral} type="submit" className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white px-6 py-3 rounded-lg text-xs font-bold tracking-widest uppercase transition-colors">
                ...
                {activeTab === 'payment' && (
                    <div className="space-y-6 animate-in fade-in duration-300">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            ...
                            <button onClick={() => setShowAddPayment(!showAddPayment)} className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg text-xs font-bold tracking-widest uppercase transition-colors shrink-0">
                        ...
                        {showAddPayment && (
                            <form onSubmit={handleAddPayment} className="bg-white/[0.02] border border-blue-500/30 rounded-xl p-6 mb-6 animate-in fade-in slide-in-from-top-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <input name="network" type="text" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                    <div className="space-y-1.5">
                                        ...
                                        <input name="ticker" type="text" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                    <div className="space-y-1.5 sm:col-span-2">
                                        ...
                                        <input name="walletAddress" type="text" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                </div>
                                ...
                                <form onSubmit={handleAddBankPayment} className="bg-white/[0.02] border border-white/[0.15] rounded-xl p-6 mb-6 animate-in fade-in slide-in-from-top-4">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input name="bankName" type="text" required placeholder="e.g. Chase Bank" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Account Name <span className="text-red-500">*</span></label>
                                            <input name="accountName" type="text" required placeholder="e.g. ARK Invest" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Account Number <span className="text-red-500">*</span></label>
                                            <input name="accountNumber" type="text" required placeholder="e.g. 1234567890" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Account Type</label>
                                            <input name="accountType" type="text" placeholder="e.g. Checking, Savings (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Currency</label>
                                            <input name="currency" type="text" defaultValue="USD" placeholder="e.g. USD" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Routing Number</label>
                                            <input name="routingNumber" type="text" placeholder="e.g. 021000021 (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">SWIFT / BIC Code</label>
                                            <input name="swiftCode" type="text" placeholder="e.g. CHASUS33 (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5 sm:col-span-2">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">IBAN</label>
                                            <input name="iban" type="text" placeholder="e.g. GB29 NWBK 6016 1331 9268 19 (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5 sm:col-span-2">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Special Instructions</label>
                                            <textarea name="instructions" rows={2} placeholder="e.g. Include your username as payment reference (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors resize-none" />
                                        </div>
                                    </div>
                                ...
                                <form onSubmit={handleAddDirect} className="bg-white/[0.02] border border-emerald-500/20 rounded-xl p-6 mb-6 animate-in fade-in slide-in-from-top-4">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <select name="type" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <input name="identifier" type="text" required placeholder="e.g. payments@company.com or $CashTag" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Display Name</label>
                                            <input name="displayName" type="text" placeholder="e.g. ARK Invest (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Instructions</label>
                                            <input name="instructions" type="text" placeholder="e.g. Include your username as memo (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                    </div>
                                ...
                                <form onSubmit={handleAddWire} className="bg-white/[0.02] border border-violet-500/20 rounded-xl p-6 mb-6 animate-in fade-in slide-in-from-top-4">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input name="beneficiaryName" type="text" required placeholder="e.g. ARK Invest" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Beneficiary Address</label>
                                            <input name="beneficiaryAddress" type="text" placeholder="e.g. 3 East 28th Street, New York NY (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Bank Name <span className="text-red-500">*</span></label>
                                            <input name="bankName" type="text" required placeholder="e.g. JPMorgan Chase" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Bank Address</label>
                                            <input name="bankAddress" type="text" placeholder="e.g. 270 Park Ave, New York (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">SWIFT / BIC Code <span className="text-red-500">*</span></label>
                                            <input name="swiftCode" type="text" required placeholder="e.g. CHASUS33" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Account Number <span className="text-red-500">*</span></label>
                                            <input name="accountNumber" type="text" required placeholder="e.g. 1234567890" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">IBAN</label>
                                            <input name="iban" type="text" placeholder="e.g. GB29 NWBK 6016 1331 (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Currency</label>
                                            <input name="currency" type="text" defaultValue="USD" placeholder="e.g. USD" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        ...
                                        <div className="space-y-1.5 sm:col-span-2">
                                            ...
                                            <input name="referenceNote" type="text" placeholder="e.g. Include your username as reference (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                        <div className="space-y-1.5 sm:col-span-2">
                                            <label className="text-[10px] uppercase tracking-widest text-white/40">Special Instructions</label>
                                            <textarea name="instructions" rows={2} placeholder="e.g. Allow 1–3 business days for wire to clear (optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors resize-none" />
                                        </div>
                                    </div>
                ...
                {activeTab === 'plans' && (
                    <div className="space-y-6 animate-in fade-in duration-300">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            ...
                            <button onClick={() => setShowAddPlan(!showAddPlan)} className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg text-xs font-bold tracking-widest uppercase transition-colors shrink-0">
                        ...
                        {showAddPlan && (
                            <form onSubmit={handleAddPlan} className="bg-white/[0.02] border border-blue-500/30 rounded-xl p-6 mb-6 animate-in fade-in slide-in-from-top-4">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <input name="name" type="text" placeholder="e.g. Starter AI" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Capital Range <span className="text-red-500">*</span></label>
                                        <input name="capitalRange" type="text" placeholder="e.g. $1,000 - $10,000" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                    <div className="space-y-1.5">
                                        ...
                                        <input name="returnLow" type="number" placeholder="e.g. 150" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Expected Return (High %)</label>
                                        <input name="returnHigh" type="number" placeholder="e.g. 250 (Optional)" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Execution Cycle <span className="text-red-500">*</span></label>
                                        <input name="cycle" type="text" placeholder="e.g. 3 Days" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Return Context <span className="text-red-500">*</span></label>
                                        <input name="returnContext" type="text" placeholder="e.g. Based on historical backtesting..." required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                    </div>
                                    <div className="space-y-1.5 sm:col-span-2">
                                        <label className="text-[10px] uppercase tracking-widest text-white/40">Description <span className="text-red-500">*</span></label>
                                        <textarea name="description" rows={2} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors resize-none" />
                                    </div>
                                    <div className="space-y-1.5 sm:col-span-2">
                                        ...
                                        <textarea name="features" rows={2} placeholder="e.g. Automated execution, Risk-adjusted, Portfolio rebalancing" required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors resize-none" />
                                    </div>
                                    ...
                                    <div className="flex flex-wrap items-center gap-4 sm:gap-6 mt-2 pt-4 border-t border-white/5 sm:col-span-2">
                                        <label className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-white cursor-pointer whitespace-nowrap">
                                            <input type="checkbox" name="highlighted" value="true" className="w-4 h-4 bg-black border border-white/20 rounded accent-blue-500 shrink-0" />
                                            Highlight Plan
                                        </label>
                                        <div className="flex items-center gap-3 flex-1 min-w-[200px]">
                                            <span className="text-[10px] uppercase tracking-widest text-white/40 whitespace-nowrap">Badge Text:</span>
                                            <input name="badge" type="text" placeholder="e.g. Most Popular" className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-3 py-1.5 text-xs text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                                        </div>
                                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            {investmentPlans.length === 0 ? (
                                ...
                                if (editingPlanId === plan._id) {
                                    return (
                                        <form key={plan._id} onSubmit={handleUpdatePlan} className="bg-white/[0.04] border border-blue-500/50 rounded-xl p-6 relative">
                                            ...
                                            <div className="space-y-4">
                                                <input name="name" type="text" defaultValue={plan.name} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50" placeholder="Plan Name" />
                                                <input name="capitalRange" type="text" defaultValue={plan.capitalRange} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50" placeholder="Capital Range" />
                                                <div className="flex gap-2">
                                                    <input name="returnLow" type="number" defaultValue={plan.returnLow} required className="w-1/2 bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50" placeholder="Min %" />
                                                    <input name="returnHigh" type="number" defaultValue={plan.returnHigh || ''} className="w-1/2 bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50" placeholder="Max % (opt)" />
                                                </div>
                                                <input name="cycle" type="text" defaultValue={plan.cycle} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50" placeholder="Cycle (e.g. 5 Days)" />
                                                <input name="returnContext" type="text" defaultValue={plan.returnContext} required className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50" placeholder="Return Context/Subtext" />
                                                <textarea name="description" defaultValue={plan.description} required rows={2} className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50 resize-none" placeholder="Description"></textarea>
                                                <textarea name="features" defaultValue={plan.features.map((f: any) => f.text).join(', ')} required rows={2} className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50 resize-none" placeholder="Features (comma separated)"></textarea>

                                                <div className="flex flex-col gap-2 pt-2">
                                                    <label className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider text-white cursor-pointer">
                                                        <input type="checkbox" name="highlighted" defaultChecked={plan.highlighted} value="true" className="w-3.5 h-3.5 bg-black border border-white/20 rounded accent-blue-500" />
                                                        Highlight Plan
                                                    </label>
                                                    <input name="badge" type="text" defaultValue={plan.badge || ''} className="w-full bg-black/50 border border-white/[0.1] rounded-lg px-3 py-2 text-xs text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50" placeholder="Badge Text (e.g. Most Popular)" />
                                                </div>

                                                <button disabled={loadingId === plan._id} type="submit" className="w-full flex justify-center items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white py-2 rounded-lg text-xs font-bold tracking-widest uppercase transition-colors mt-2">
                                ...
                                return (
                                    <div key={plan._id} className={`flex flex-col rounded-xl p-6 relative ${plan.highlighted ? 'bg-white/[0.04] border border-blue-500/30' : 'bg-white/[0.02] border border-white/[0.08]'}`}>
                                        {plan.badge && (
                                        ...
                                        <div className="space-y-2 mt-auto border-t border-white/[0.04] pt-4">
                                            {plan.features.slice(0, 3).map((f: any, i: number) => (
                                                <div key={i} className="flex items-start gap-2 text-[10px] text-white/40 tracking-wide uppercase">
                                                    <Check className="w-3 h-3 text-blue-500 shrink-0 mt-0.5" /> {f.text}
                                                </div>
                                            ))}
                ...
                {activeTab === 'support' && (
                    <form onSubmit={handleSaveSupport} className="space-y-8 max-w-xl animate-in fade-in duration-300">
                        ...
                        <div className="space-y-3">
                            {/* Smartsupp option */}
                            <label className={`flex items-start gap-4 p-5 rounded-xl border cursor-pointer transition-all ${supportMode === 'smartsupp' ? 'border-blue-500/50 bg-blue-500/[0.06]' : 'border-white/[0.08] bg-white/[0.02] hover:border-white/[0.15]'}`}>
                                <input
                                    type="radio"
                                    name="mode"
                                    value="smartsupp"
                            ...
                            {/* Telegram option */}
                            <label className={`flex items-start gap-4 p-5 rounded-xl border cursor-pointer transition-all ${supportMode === 'telegram' ? 'border-blue-500/50 bg-blue-500/[0.06]' : 'border-white/[0.08] bg-white/[0.02] hover:border-white/[0.15]'}`}>
                                <input
                                    type="radio"
                                    name="mode"
                                    value="telegram"
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="flex items-center gap-0">
                                                ...
                                                <input
                                                    ...
                                                    className="flex-1 bg-white/[0.03] border border-white/[0.1] rounded-r-lg px-4 py-3 text-sm text-white placeholder-white/20 focus:outline-none focus:border-blue-500/50 transition-colors"
                                                />
                                            </div>
                                        </div>
                                    )}
                        ...
                        <div className="pt-4 border-t border-white/[0.05]">
                            <button
                                ...
                                type="submit"
                                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white px-6 py-3 rounded-lg text-xs font-bold tracking-widest uppercase transition-colors"
                            >
                    ...
                    <form onSubmit={handleUpdatePassword} className="space-y-6 max-w-xl animate-in fade-in duration-300">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input name="currentPassword" type="password" required className="w-full bg-white/[0.03] border border-white/[0.1] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[10px] uppercase tracking-widest text-white/40">New Password <span className="text-red-500">*</span></label>
                                <input name="newPassword" type="password" required className="w-full bg-white/[0.03] border border-white/[0.1] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                            </div>
                            <div className="space-y-1.5">
                                ...
                                <input name="confirmPassword" type="password" required className="w-full bg-white/[0.03] border border-white/[0.1] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors" />
                            </div>
                        </div>
                        <div className="pt-4 border-t border-white/[0.05]">
                            <button disabled={isSavingSecurity} type="submit" className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white px-6 py-3 rounded-lg text-xs font-bold tracking-widest uppercase transition-colors">
                ...
                {activeTab === 'referral' && (
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full bg-white/[0.03] border border-white/[0.1] rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors"
                                />
                        ...
                        <div className="pt-4 border-t border-white/[0.05]">
                            <button disabled={isSavingReferral} type="submit" className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white px-6 py-3 rounded-lg text-xs font-bold tracking-widest uppercase transition-colors">
