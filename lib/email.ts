...
const FROM_NAME = (process.env.SMTP_FROM_NAME || "ARK Invest").trim();
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  <h1 style="font-size: 22px; letter-spacing: 3px; text-transform: uppercase; margin: 0 0 4px;">
    ARK <span style="color: #3B82F6;">Invest</span>
  </h1>
  ...
  <p style="color: #aaa; line-height: 1.7; margin: 0 0 24px;">
    Thank you for registering with ARK Invest. Please use the verification code below to complete your account setup.
  </p>
  ...
  <p style="color: #444; font-size: 11px; margin: 0;">Do not share this code with anyone. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <p style="color: #aaa; line-height: 1.7; margin: 0 0 24px;">
    Your ARK Invest account is active and ready to use. You can log in and start building your portfolio right now.
  </p>
  ...
  <ul style="color: #888; font-size: 13px; line-height: 2; padding-left: 20px; margin: 0 0 28px;">
    ...
    <li>Thematic innovation strategies and research</li>
    <li>Real-time transaction tracking and analytics</li>
  </ul>

  <a href="${loginUrl}" style="display: inline-block; background-color: #3B82F6; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 50px; font-size: 13px; font-weight: bold; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 28px;">
    Go to Dashboard
  </a>

  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">If you did not create this account, please disregard this email. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">If you did not submit this application, please contact support immediately. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <a href="${dashboardUrl}" style="display: inline-block; background-color: #3B82F6; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 50px; font-size: 13px; font-weight: bold; letter-spacing: 2px; text-transform: uppercase; margin-bottom: 28px;">
    View Your Membership Card
  </a>

  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">Thank you for being a valued member. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">If you believe this was an error, please contact our support team. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">If you did not make this deposit, please contact support immediately. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">Thank you for investing with us. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">If you did not request this withdrawal, please contact support immediately. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">Thank you for using ARK Invest. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">If you believe this was an error, please contact support. &copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">&copy; ARK Invest</p>
</div>`;
}
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background-color: #0a0a0a; color: #ffffff; border-radius: 12px;">
  ...
  <p style="color: #aaa; line-height: 1.7; margin: 0 0 24px;">
    Great news! Your ARK Invest account has been reviewed and approved. You now have full access to the platform and can start investing today.
  </p>
  ...
  <hr style="border: none; border-top: 1px solid #222; margin-bottom: 20px;" />
  <p style="color: #444; font-size: 11px; margin: 0;">If you did not create this account, please contact support. &copy; ARK Invest</p>
</div>`;
}
