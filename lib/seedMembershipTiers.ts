...
const SEED_TIERS = [
    {
        name: "Silver",
        slug: "silver",
        description: "The entry point into the ARK Invest Membership Programme. Designed for emerging investors seeking premium access and portfolio support.",
        benefits: [
    ...
    },
    {
        ...
        benefits: [
            ...
            "Access to Gold-tier preferred financing rates",
    ...
    },
    {
        ...
        benefits: [
            ...
            "Premium financing (0% processing fee)",
            "Access to pre-IPO project tranches",
            "Monthly 1-on-1 portfolio review call",
            "Invitations to ARK Invest private events",
        ],
        colorFrom: "#0d0d1a",
        colorTo: "#1a1a35",
        accentColor: "#8b9fd4",
    ...
    },
    {
        name: "Black",
        slug: "black",
        description: "The pinnacle of ARK Invest membership. Black Card holders are our most valued partners — ultra-exclusive, invitation-only, with unparalleled privileges.",
        benefits: [
            ...
            "VIP acquisition concierge service",
        ...
        accentColor: "#e8c97a",
        annualFee: 9999,
        requirements: "By invitation only. Minimum portfolio value of $1,000,000 or exceptional contribution to the ARK Invest community.",
        sortOrder: 4,
        isActive: true,
    },
];
