...
const faqs = [
    {
        ...
        a: "ARK Invest is a disruptive innovation investment platform that provides accredited and retail investors structured access to the technologies shaping the future — including AI, Robotics, Genomics, Fintech, Energy Storage, and Blockchain — alongside AI-managed trading plans.",
    },
    {
    ...
    },
    {
        ...
        a: "Yield distributions are credited directly to your ARK Invest account balance on the schedule defined by your plan or strategy (daily, weekly, or monthly). You can withdraw funds to your linked payment method at any time.",
    },
    {
    ...
    },
    {
        ...
        a: "Innovation strategies give you structured exposure to specific technology themes (AI, Genomics, etc.) and earn yield tied to portfolio performance. AI Plans are systematic trading strategies managed algorithmically across diversified markets, with returns generated through position management rather than equity ownership.",
    },
    {
...
const steps = [
    ...
    },
    {
        ...
        points: [
            "Innovation strategies: AI, Genomics, Fintech, Energy, Space",
...
const tracks = [
    {
        ...
        description:
            "Gain structured exposure to disruptive innovation themes across AI, Genomics, Fintech, Energy Storage, and Space. Each strategy offers tiered entry points with defined yield structures.",
        highlights: [
            "AI & Robotics Platform",
            "Genomic Revolution Fund",
...
const pillars = [
    {
        ...
        description:
            "Invest in structured strategies targeting AI, Genomics, Fintech, and other disruptive innovation themes not available through traditional brokers.",
    },
    {
        icon: Bot,
        title: "AI Trading Plans",
    ...
    },
    {
        ...
        description:
            "Access deep research into convergent technologies and exponential growth curves powering the next decade of innovation.",
    },
];
    ...
    return (
        <main className="bg-black text-white overflow-hidden">
            ...
            <section className="relative w-full min-h-[70vh] flex items-center justify-center overflow-hidden pt-[70px]">
                ...
                />
                {/* Blue glow */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-600/[0.05] rounded-full blur-[120px] pointer-events-none" />
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 sm:py-32 text-center">
                    ...
                    >
                        ARK Invest gives you structured access to disruptive innovation — the technologies reshaping the future — alongside AI-powered trading strategies and deep thematic research.
                    </motion.p>
                        ...
                        {pillars.map((p, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-7 hover:border-blue-500/20 hover:bg-white/[0.05] transition-all duration-400"
                                >
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex sm:flex-col items-center sm:items-start gap-4 sm:gap-0 shrink-0">
                                        ...
                                        <div className="sm:mt-3 w-9 h-9 rounded-lg bg-blue-600/10 flex items-center justify-center">
                                    ...
                                    <div className="flex-1">
                                        <div className="w-8 h-[3px] bg-blue-500 rounded-full mb-4 hidden sm:block" />
                                        <h3
                                        ...
                                        <ul className="flex flex-col gap-2">
                                            {step.points.map((pt) => (
                                                <li key={pt} className="flex items-start gap-2.5">
                                                    <CheckCircle2 className="w-4 h-4 text-blue-500 mt-[1px] shrink-0" />
                                    ...
                                    <ul className="flex flex-col gap-2 mb-7">
                                        {plan.features.slice(0, 4).map((f) => (
                                            <li key={f.text} className="flex items-start gap-2">
                                                <span className="w-1 h-1 rounded-full bg-blue-500/50 mt-[5px] shrink-0" />
                        ...
                        {[
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="w-9 h-9 rounded-xl bg-blue-600/10 flex items-center justify-center mx-auto mb-4">
                                        <Icon className="w-5 h-5 text-blue-500" />
                                    </div>
                                    <h3
            ...
            <section className="relative w-full bg-black py-24 sm:py-32 border-t border-white/[0.04] overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-600/[0.06] rounded-full blur-[100px] pointer-events-none" />
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
                    ...
                    >
                        Create your account in minutes, complete verification, and gain access to innovation-focused investments not available anywhere else.
                    </motion.p>
