...
const pillars = [
    {
        ...
        desc: "We structure investment strategies that give retail and accredited investors direct exposure to disruptive innovation themes — AI, Robotics, Genomics, Fintech, Energy Storage, and Blockchain.",
    },
    {
        icon: Bot,
    ...
    },
    {
        ...
        desc: "Deep research into convergent technologies and exponential growth curves — identifying the companies and sectors poised to reshape entire industries over the next decade.",
    },
];
...
const timeline = [
    {
        year: "2021",
        title: "Foundation",
        desc: "ARK Invest was founded with a single conviction: investing in disruptive innovation should not be exclusive to institutions. The platform concept was developed.",
    },
    {
        year: "2022",
    ...
    },
    {
        ...
        desc: "The first AI & Robotics and Genomic Revolution strategies launched as live investment opportunities. Hundreds of early investors gained their first structured innovation exposure.",
    },
    {
        year: "2024",
    ...
    },
    {
        year: "2026",
        title: "Today",
        desc: "A fully integrated innovation investment and AI trading platform. Multiple live strategies, active AI plans, and a growing global investor community.",
    },
];
    ...
    return (
        <main className="bg-black text-white overflow-hidden">
            ...
            <section className="relative w-full min-h-[75vh] flex items-center justify-center overflow-hidden pt-[70px]">
                ...
                />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-blue-600/[0.04] rounded-full blur-[140px] pointer-events-none" />
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 sm:py-32 text-center">
                    ...
                    >
                        About ARK
                        <br />
                        <span className="text-white/25">Invest</span>
                    </motion.h1>
            ...
            <section className="relative w-full bg-zinc-50 py-20 sm:py-28 overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                        ...
                        >
                            <span className="inline-block text-[11px] tracking-[0.3em] uppercase text-blue-600 font-semibold mb-5">
                                Our Mission
                            </span>
                            <h2
                        ...
                        >
                            ...
                            <p className="text-base text-black/60 font-light leading-relaxed mb-5">
                                We envision a future where retail investors hold meaningful positions in the technologies reshaping civilisation: the AI systems that reason, the genomics that heal, the fintech that empowers.
                            </p>
                            <p className="text-sm text-black/50 font-light leading-relaxed mb-8">
                                That future is not a distant ambition — it is what ARK Invest is building right now, one verified investor and one funded strategy at a time.
                            </p>
                        ...
                        {pillars.map((p, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-8 hover:border-blue-500/20 hover:bg-white/[0.05] transition-all duration-400 flex flex-col"
                                >
                                        ...
                                        <div className={`w-9 h-9 sm:w-11 sm:h-11 rounded-full border flex items-center justify-center z-10 relative ${
                                            ...
                                            <span
                                                className={`text-[10px] font-black tracking-tight ${
                                                    item.year === "2026" ? "text-blue-400" : "text-white/40"
                                                }`}
                                                style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                                            >
                                                {item.year.slice(2)}
                        ...
                        {values.map((v, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="bg-white rounded-2xl p-7 border border-black/[0.04] shadow-[0_1px_3px_rgba(0,0,0,0.05),0_6px_20px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(59,130,246,0.08)] hover:border-blue-500/10 transition-all duration-300"
                                >
                                    ...
                                    <div className="w-6 h-[2px] bg-blue-500/30 rounded-full mb-3" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        {team.filter((m: any) => !m.featured).map((member, i) => (
                            ...
                            >
                                ...
                                <p className="text-[10px] tracking-[0.15em] uppercase text-blue-500/70 font-medium mb-4">
                                    {member.role}
                                </p>
            ...
            <section className="relative w-full bg-zinc-950 py-24 sm:py-32 border-t border-white/[0.04] overflow-hidden">
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
                    ...
                    >
                        Create a free account in minutes and gain access to innovation-focused investments in the technologies defining the next century.
                    </motion.p>
