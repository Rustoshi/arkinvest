        ...
        <main className="bg-black text-white overflow-hidden">
            ...
            <section className="relative w-full min-h-[65vh] flex items-center justify-center overflow-hidden pt-[70px]">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 sm:py-32 text-center">
                    ...
                    >
                        ARK Invest is a global team of engineers, analysts, compliance specialists, and operators building the platform that gives everyone access to innovation-focused investments in the technologies shaping the future.
                    </motion.p>
                </div>
            </section>
            ...
            <section className="relative w-full bg-black py-20 sm:py-28 border-t border-white/[0.04]">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-6">
                    ...
                    >
                        ...
                        <a
                            href="mailto:info@arkinvests.pro?subject=Speculative Application"
            ...
            <section className="relative w-full bg-zinc-50 py-20 sm:py-28 overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-6">
                    <motion.div
                        ...
                        className="mb-14"
                    >
                        <span className="inline-block text-[11px] tracking-[0.3em] uppercase text-blue-600 font-semibold mb-4">Benefits</span>
                        <h2
