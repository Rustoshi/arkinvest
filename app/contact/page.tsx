...
const faqs = [
    ...
    { q: "What strategies are available?", href: "/ai-plans" },
];
    ...
    return (
        <main className="bg-black text-white overflow-hidden">
            ...
            <section className="relative w-full min-h-[52vh] flex items-center justify-center overflow-hidden pt-[70px]">
                ...
                />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-blue-600/[0.04] rounded-full blur-[120px] pointer-events-none" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        {channels.map((ch, i) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="w-9 h-9 rounded-xl bg-blue-600/10 flex items-center justify-center mb-4">
                                ...
                                >
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white/[0.04] border border-white/[0.1] rounded-xl px-4 py-3.5 text-sm text-white placeholder-white/20 focus:outline-none focus:border-blue-500/40 focus:bg-white/[0.06] transition-all duration-200"
                                            />
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            value={form.subject}
                                            onChange={handleChange}
                                            className="w-full bg-white/[0.04] border border-white/[0.1] rounded-xl px-4 py-3.5 text-sm text-white/70 focus:outline-none focus:border-blue-500/40 transition-all duration-200 appearance-none"
                                        >
                                            ...
                                            <option value="Strategies" className="bg-zinc-900">Investment Strategies</option>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-white/[0.04] border border-white/[0.1] rounded-xl px-4 py-3.5 text-sm text-white placeholder-white/20 focus:outline-none focus:border-blue-500/40 focus:bg-white/[0.06] transition-all duration-200 resize-none"
                                        />
                                    </div>
                                    <button
                                        type="submit"
                                        disabled={status === "submitting"}
                                        className="flex items-center justify-center gap-2 w-full py-4 rounded-full bg-blue-600 text-white text-sm font-semibold tracking-[0.1em] uppercase hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
                                        style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                                    >
