        ...
        >
            ...
            <ul className="flex flex-col gap-3 flex-1 mb-9">
                {plan.features.map((f) => (
                    <li key={f.text} className="flex items-start gap-2.5">
                        <span className="w-1 h-1 rounded-full bg-blue-500/50 mt-[7px] shrink-0" />
            ...
            <Link
                ...
                className={`block w-full text-center py-3.5 text-sm font-semibold tracking-[0.08em] uppercase rounded-full transition-all duration-300 ${
                    plan.highlighted
                        ? "bg-blue-600 text-white hover:bg-blue-500 shadow-[0_0_24px_rgba(59,130,246,0.25)]"
...
const faqs = [
    ...
    },
    {
        ...
        a: "The AI strategies primarily target innovation-driven equities including NVIDIA, AMD, and other high-growth technology sectors, alongside broader index exposure for diversification.",
    },
    {
    ...
    return (
        <main className="bg-black text-white overflow-hidden">
            ...
            <section className="relative w-full min-h-[70vh] flex items-center justify-center overflow-hidden pt-[70px]">
                ...
                />
                <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-blue-600/[0.06] rounded-full blur-[130px] pointer-events-none" />
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 py-24 sm:py-32 text-center">
                    ...
                    >
                        ...
                        <span className="text-[11px] tracking-[0.35em] uppercase text-blue-500 font-semibold">
                            AI Capital Programs
                        </span>
                    </motion.div>
                    ...
                    >
                        <a
                            ...
                            className="px-8 py-3.5 rounded-full bg-blue-600 text-white text-sm font-semibold tracking-[0.08em] uppercase hover:bg-blue-500 transition-colors duration-300 cursor-pointer"
                            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                        >
                            View All Plans
                        </a>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
                        {riskBlocks.map((block, i) => (
                            <motion.div
                                ...
                                className="bg-white rounded-2xl p-7 border border-black/[0.05] shadow-[0_1px_3px_rgba(0,0,0,0.06),0_8px_24px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(59,130,246,0.08)] hover:border-blue-500/10 transition-all duration-300"
                            >
                                <span
                                ...
                                <div className="w-7 h-[2px] bg-blue-500/30 rounded-full mb-3" />
            ...
            <section className="relative w-full bg-black py-24 sm:py-32 border-t border-white/[0.04] overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-blue-600/[0.06] rounded-full blur-[120px] pointer-events-none" />
