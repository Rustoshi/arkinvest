...
const COMPANY = "ARK Invest";
const EMAIL = "info@arkinvests.pro";
            ...
            <section className="relative w-full bg-zinc-50 py-20 sm:py-24 overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6">
                    <motion.div
                        ...
                        className="mb-12"
                    >
                        <span className="inline-block text-[11px] tracking-[0.3em] uppercase text-blue-600 font-semibold mb-4">Know Your Customer</span>
                        <h2
                    ...
                    <div className="flex flex-col gap-8">
                        {kycSections.map((s, i) => (
                            ...
                            >
                                ...
                                <div className="w-6 h-[2px] bg-blue-500/40 rounded-full mb-4" />
