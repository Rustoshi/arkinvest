        ...
        <div className="min-h-[100dvh] bg-black flex items-start sm:items-center justify-center px-6 py-20 pt-24 sm:py-24 overflow-y-auto">
            ...
            >
                ...
                <div className="text-center mb-10">
                    ...
                    >
                        ARK <span className="text-blue-500">Invest</span>
                    </Link>
                </div>
                        ...
                        {step === 1 && (
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full py-3.5 bg-blue-600 text-white text-sm font-semibold tracking-[0.1em] uppercase rounded-full transition-all duration-300 hover:bg-blue-500 hover:scale-[1.02] shadow-[0_0_20px_rgba(59,130,246,0.2)] mt-2 disabled:opacity-50 disabled:hover:scale-100 flex items-center justify-center gap-2 cursor-pointer"
                                    style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                                >
                                    {isLoading ? (
                                        <>
...
export default function SignupPage() {
    return (
        <Suspense fallback={<div className="min-h-[100dvh] bg-black flex items-center justify-center"><div className="w-8 h-8 border-4 border-blue-600 border-t-transparent rounded-full animate-spin" /></div>}>
            <SignupForm />
        </Suspense>
    );
}
