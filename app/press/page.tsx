...
const coverage = [
    {
        outlet: "Forbes",
        date: "March 2026",
        headline: "ARK Invest Is Giving Retail Investors Access to Disruptive Innovation Strategies",
        excerpt: "The fintech platform is bridging the gap between institutional innovation investing and everyday investors, with structured strategies starting at $1,000.",
        tag: "Feature",
    ...
    },
    {
        outlet: "Bloomberg",
        date: "January 2026",
        headline: "AI-Managed Trading Meets Innovation Investing in New Platform",
        excerpt: "ARK Invest has launched an algorithmic trading layer alongside its innovation investment strategies, allowing investors to deploy capital across both approaches.",
        tag: "Coverage",
    ...
    },
    {
        outlet: "TechCrunch",
        date: "November 2025",
        headline: "The Platform Democratising Access to Disruptive Innovation",
        excerpt: "Unlike token-based investment products, ARK Invest offers structured innovation strategies that mirror institutional deal terms at retail-accessible minimums.",
        tag: "Spotlight",
    ...
    },
    {
        outlet: "Wired",
        date: "July 2025",
        headline: "Why Thousands of Investors Are Betting on AI and Genomics Through New Platforms",
        excerpt: "Structured innovation strategies, once reserved for family offices and sovereign wealth funds, are reaching a new class of retail participants.",
        tag: "Feature",
        tagColor: "text-amber-400 border-amber-400/30 bg-amber-400/[0.05]",
    },
    {
        outlet: "CoinDesk",
        date: "April 2025",
        headline: "ARK Invest Adds Crypto Deposit Rails for Global Investors",
...
const releases = [
    {
        date: "Apr 2026",
        title: "ARK Invest Surpasses $50M in Investor Deposits Across Active Strategies",
    },
    {
        date: "Feb 2026",
    ...
    {
        date: "Oct 2025",
        title: "ARK Invest Expands to 50+ Countries, Adds EUR and GBP Deposit Support",
    },
    {
        date: "Aug 2025",
        title: "Energy Storage Strategy Opens for Retail Investment",
    },
    {
        date: "May 2025",
        title: "AI & Robotics Innovation Fund Fully Subscribes Explorer and Pioneer Tiers",
    },
];
        ...
        <main className="bg-black text-white overflow-hidden">
            ...
            <section className="relative w-full min-h-[55vh] flex items-center justify-center overflow-hidden pt-[70px]">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 sm:py-28 text-center">
                    ...
                    >
                        Resources, coverage, and contact information for journalists and media professionals covering ARK Invest.
                    </motion.p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <motion.a
                                ...
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                href="mailto:info@arkinvests.pro?subject=Press Kit Request"
            ...
            <section className="relative w-full bg-black py-20 border-t border-white/[0.04]">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <span className="inline-block text-[11px] tracking-[0.3em] uppercase text-blue-500 font-semibold mb-5">Media Enquiries</span>
                        <h2
                        ...
                        <a
                            href="mailto:info@arkinvests.pro"
                            ...
                            style={{ fontFamily: "var(--font-montserrat), sans-serif" }}
                        >
                            <Mail className="w-4 h-4" /> info@arkinvests.pro
                        </a>
